...
from .mock_trends import MockTrendsData, StaticTrendsData


class TrendsAdapter:
    """统一的趋势数据访问接口"""

    def __init__(self, seed: Optional[int] = None, trends: Optional[List[Dict]] = None):
        if trends is not None:
            self.data_source = StaticTrendsData(trends)
        else:
